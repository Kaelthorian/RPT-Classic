/client/verb/Who()
	...
	for(var/mob/player/M in world)if(M.client)
		...
		: M.z==11 ? "Hell" : M.z==6 ? "Dark Planet" : M.z==10 ? "Majin Absorb Area/Heaven" : M.z==17 ? "Ships/Magic Realms" : M.z==7 ? "Space Station" : M.z==9 ? "Final Realms/Tower/HBTC" : \
		...
		if(usr.client.holder)
			peeps += {"\t<tr><td><font color=[M.TextColorOOC]>[M.key]</td>
						...
						<td>[planet]</td>
						<td>[M.RPs]</center></td>
						<td>[M.EXPLifetime]</center></td>
						<td>EXP: [M.EXP] / MPs: [M.MilestonePoints]</center></td>
						<td>[M.SaveAge]</center></td>
	...
	if(usr.client.holder) dat += "<font color=#80d8FF><table border=1 cellspacing=5><B><tr><th>Key</th><th>Name</th><th>Race</th><th>Planet</th><th>Total RP Count</th><th>EXP Count Current Lifetime</th><th>EXP Overflow</th><th>Unused EXP/MPs</th><th>Save Age</th><th>Admin Options</th></tr></B>"
