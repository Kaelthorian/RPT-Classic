obj/items/
	Slot_Machine
		...
		var/list/symbols = list("Cherry" = 12000, "Bell" = 20000, "Amethyst" = 15000, "Lemon" = 5000, "Topaz" = 14000, "Bar" = 40000,
		"Seven" = 60000, "Horseshoe" = 10000, "Diamond" = 80000)
		// var/free_spins = 0 free spins just get added on
		var/money = 0
		var/spins = 0
		var/total_spins = 0
		var/total_earned = 0
