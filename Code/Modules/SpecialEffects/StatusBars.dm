...
mob/verb
	Graphics_Options()
		set category=null
		var/PP=input("Change what option?","Graphics Options") in list("Set FPS","Screen Size","Toggle Scouter Overlays","Toggle Team Overlays","Toggle Body Part HUD","Show HUD","Text Size","Cancel")
		switch(PP)
