Team/
	var
		openJoining=0											//Allows for a team to allow people near
																...
																//Given you have room
		maxMembers=25											//Allows for parties to have limits on
		...
		Leave_Team()
			...
			switch(input(src,"Are you sure you want to leave [src.Team.Members[1]]'s team?","Leave Team") in list("Yes","No"))
				...
				if("Yes")										//If they do, remove their old team.
					...
					src.Team=new()
					src.Team.AddMember(src)
					range(20,src)<<"[src.name] left his team"
...
<div class="main">
<center><h2>[src.name]'s Team</h2></center>
Amount of members: [src.Team.Members.len]<br>
Members:<br>
[src.Team.Members.Join(", ")]<br>
</div>
</body>
</html>
	...
	"}
			usr<<browse(Tview,"window='Team Window';size=350x250")
...
//				l.Add("Cancel")
				...
				l+="Cancel"
//				world<<"[l]"
				if(!usr.Confirm("Are you sure you want to add him to your team?")) return
