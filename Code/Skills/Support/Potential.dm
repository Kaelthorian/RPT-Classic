Skill/Support/Unlock_Potential
	...
	New()
		desc="This will grant someone [BPMod]x BPMod. This will also make their energy appear more pure."
		..()
...
Skill/Support/Dark_Blessing
	...
	var/LastUse=0 //The year you may next use this.
	New()
		desc="This will grant someone [BPMod]x BPMod. This will also make their energy appear more evil."
		..()
