Skill/Buff/T1/MirageForce
	buffon="begins focusing their energy into their footwork."
	buffoff="stops focusing their energy into their footwork."
	BP=1
	Def=1.25
	desc="This buff will boost your Def by 1.25."
