...
Skill/MartialArt
	...
	proc
		...
		buff(mob/user) if(!Using)
			...
			user.StanceStr		*=src.StrMult
			user.StanceEnd		*=src.EndMult
			user.StanceSpd		*=src.SpdMult
			user.StanceForce	*=src.PowMult
			user.StanceOff		*=src.OffMult
			user.StanceDef		*=src.DefMult
