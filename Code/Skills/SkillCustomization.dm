...
mob/verb/Customize()
	...
	overlays.Remove(BlastCharge,/Icon_Obj/Cloak/SSJ1,/Icon_Obj/Cloak/LSSJ,/Icon_Obj/Cloak/SN,/Icon_Obj/Cloak/SSR,/Icon_Obj/Cloak/SSGSS,/Icon_Obj/Cloak/SSGFP,/Icon_Obj/Cloak/SSRFP,'Aura SSj3.dmi','Sparks LSSj.dmi','SNj Elec.dmi',\
...
Icon_Obj/Customization/Blasts
	...
	Click()
		var/list/C=new
		for(var/Skill/Attacks/D in usr) if(D.type!=/Skill/Attacks/Time_Freeze) if(D.type!=/Skill/Attacks/T3/MegaBurst) C+=D
		//usr.Tabs=1
